...
- **In flat light, pick by the scene's value.** Color-led (foliage) → Fortia rescues (confirmed close-range too), SCU merely records; form/tone/texture-led → mono. Mono is the wrong tool when color is the point.
- **Loki & Schaller are condition-dependent tools, not portable looks.** They need hard directional light **and** EV −2/3; in flat shade at normal exposure they collapse to flat/high-key. Check the precondition before choosing them. See [[concepts/condition-dependent-recipes]].
...
- **Skin recipe follows the face, not just the light.** High Clarity/Sharpness flatters aged/textured/adult-male faces, harms smooth/young skin. EV is a second dial — brighter softens, darker models. See [[concepts/portraits-and-skin-rendering]].
