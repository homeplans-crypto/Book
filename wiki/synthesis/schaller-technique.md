...
# Alan Schaller — technique repository

A **living, growing repository** of [[entities/schaller|Alan Schaller]]'s own technique, distilled from his videos/interviews into discrete, citable details. Populated incrementally: the human copies in more transcripts over time. This is the *practice* counterpart to [[recipes/schaller]] (Schaller Dark) / [[recipes/schaller-luminous]] — the recipes are the small part; this is the lever.
...
- Leica **M10 Monochrom** (dedicated mono sensor). `[NS]`
- Fast primes: **24mm Summilux f/1.4** + a **50mm f/1.4**. `[NS]`
- *"A 1.4 lens can gather twice as much light as an F2 lens."* `[NS]`

## Exposure & camera settings

- **Aperture priority**; **Auto ISO capped 6400**; **shutter floor 1/125 s**. `[NS]`
- **Exposure compensation ≈ −2**, especially into halogens. `[NS]`
- Underexpose rationale: *"most of the dynamic range comes from boosting out of the shadows rather than cutting back on highlight — so it's the smart move to underexpose on digital."* Assumes RAW + post shadow-boost. `[NS]`
- Uses **blinkies** to place pure-black and pure-white deliberately, *next to the subject's head*. `[NS]`
...
- Night = mood/atmosphere + **high contrast "without working hard for it."** `[NS]`
- Night = **fewer people** → the isolation he wants. `[NS]`
- Best night cities: London, Tokyo, Hong Kong, Paris, Havana. `[NS]`
