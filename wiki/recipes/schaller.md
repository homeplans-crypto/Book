...
> Source note 2026-05-17 ([[sources/schaller-night-shooting]], [[synthesis/schaller-technique]]): **author-confirmed.** Schaller's own night method is **EV ≈ −2, "underexpose, recover from the shadows"** — validating this recipe's baked-in EV −2/3 / expose-for-highlights philosophy *and* the same-day camera correction. Caveat: his −2 is RAW + post shadow-boost on a Monochrom; this recipe is −2/3 baked into a JPEG that can't lift shadows as far — keep the −2/3, do **not** chase his literal −2.

> Shooting discipline 2026-05-18 ([[synthesis/schaller-technique]] — `[NS]` `[CO]` `[BW]`): the videos **confirm this recipe's dials; the change is in how you shoot it.** (1) Use the **blinkies** to place pure-black and pure-white deliberately, *next to the subject's head*. (2) The contrast/negative space is **there** in hard or night light — *find* it; do not expect Shadow +4 to manufacture drama from flat light (the [[concepts/condition-dependent-recipes|condition-dependent]] rule, in his words: "no such thing as bad light — change the subject, don't force the look"). (3) At night, **wet pavement after rain = a burst of highlights** — seek it. (4) **Subframe** (a light/arch/structure) and shoot with **intention** ("what am I trying to do here?"). (5) EV −2/3 is *his* method (he shoots ≈ −2, RAW+post); keep −2/3 — don't chase his literal −2 (no JPEG shadow-recovery). Per the 2026-05-18 roster review, **Dark takes no dial change**; only A/B #3 (the +Ye taste fix) applies.
